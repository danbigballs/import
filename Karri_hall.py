...
# ——— Hall Sensors —————————————————————————————————————————————————————
record_sensor = digitalio.DigitalInOut(board.D8)
record_sensor.direction = digitalio.Direction.INPUT
record_sensor.pull = digitalio.Pull.UP

cancel_sensor = digitalio.DigitalInOut(board.D7)
cancel_sensor.direction = digitalio.Direction.INPUT
cancel_sensor.pull = digitalio.Pull.UP
...
try:
    while True:
        ...
        # ——— New Hall Sensor State Logic ———
        if not record_sensor.value:
            y_state = 'record'
        elif not cancel_sensor.value:
            y_state = 'cancel_zone'
        else:
            y_state = 'neutral'
